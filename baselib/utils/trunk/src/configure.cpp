...
// class Configure
int Configure::load(const char *file)
{
	vector<string> lines;
...
int Configure::get_single(const char *section, const char *key, string &val)
{
	Value *v = NULL;
...
int Configure::get_single(const char *section, const char *key, long &val)
{
	string s;
...
int Configure::get_single(const char *section, const char *key, double &val)
{
	string s;
	int rc = get_single(section, key, s);
	if (0 != rc) {
...
int Configure::count1_array(const char *section, const char *key, int &count)
{
	Value *v = NULL;
	int rc = get_value(section, key, v);
	if (0 != rc) {
...
int Configure::get_array(const char *section, const char *key, int i, string &val)
{
	Value *v = NULL;
	int rc = get_value(section, key, v);
	if (0 != rc) {
...
int Configure::get_array(const char *section, const char *key, int i, long &val)
{
	string s;
...
int Configure::get_array(const char *section, const char *key, int i, double &val)
{
	string s;
	int rc = get_array(section, key, i, s);
	if (0 != rc) {
...
int Configure::count1_array2(const char *section, const char *key, int &count)
{
	Value *v = NULL;
	int rc = get_value(section, key, v);
	if (0 != rc) {
...
int Configure::count2_array2(const char *section, const char *key, int i, int &count)
{
	Value *v = NULL;
	int rc = get_value(section, key, v);
	if (0 != rc) {
...
int Configure::get_array2(const char *section, const char *key, int i, int j, string &val)
{
	Value *v = NULL;
	int rc = get_value(section, key, v);
	if (0 != rc) {
...
int Configure::get_array2(const char *section, const char *key, int i, int j, long &val)
{
	string s;
...
int Configure::get_array2(const char *section, const char *key, int i, int j, double &val)
{
	string s;
	int rc = get_array2(section, key, i, j, s);
	if (0 != rc) {
...
int Configure::save(const char *file)
{
	// 读取配置文件, 分析出注释
...
int Configure::set_single(const char *section, const char *key, const string &val)
{
	Value *v = NULL;
	int rc = get_value(section, key, v);
	if (0 != rc) {
...
int Configure::set_array(const char *section, const char *key, const vector<string> &val)
{
	Value *v = NULL;
	int rc = get_value(section, key, v);
	if (0 != rc) {
...
int Configure::set_array2(const char *section, const char *key, const vector<vector<string> > &val)
{
	Value *v = NULL;
	int rc = get_value(section, key, v);
	if (0 != rc) {
...
int Configure::get_section(const char *section, Section *&sec)
{
	for (size_t i = 0; i < m_configure.size(); i++)
	{
...
int Configure::get_value(const char *section, const char *key, Value *&value)
{
	Section *sec = NULL;
...
int Configure::add_section(const char *section, const char *comment1, const char *comment2)
{
	Section *s = NULL;
...
int Configure::add_value_single(const char *section, const char *key, const char *value, const char *comment1, const char *comment2)
{
	Section *sec = NULL;
	int rc = get_section(section, sec);
	if (0 != rc) {
...
int Configure::add_value_array(const char *section, const char *key, const char *line, const char *comment1, const char *comment2)
{
	Section *sec = NULL;
	int rc = get_section(section, sec);
	if (0 != rc) {
...
int Configure::add_value_array2(const char *section, const char *key, const vector<string> &lines, const char *comment1, const char *comment2)
{
	Section *sec = NULL;
	int rc = get_section(section, sec);
	if (0 != rc) {
