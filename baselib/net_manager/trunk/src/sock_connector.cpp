...
SOCK_Connector::SOCK_Connector(Net_Manager *net_manager, Packet_Splitter *packet_splitter, void* pUserData)
{
...
int SOCK_Connector::handle_output()
{
	...
	// create stream
	SOCK_Stream *stream = new SOCK_Stream(m_id, m_net_manager, m_packet_splitter, m_socket, local_addr, m_remote_addr, m_UserData);
